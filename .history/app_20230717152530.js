...
app.get("/shoppage/:sname/script1.js",(request,response)=>
{
    // let shopnamerequested = request.params.sname;
    // console.log(shopnamerequested)
    response.render("shopspage",{name:request.params.sname});
});
